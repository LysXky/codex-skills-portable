...
CANARY_FILE_TEMPLATES = {
    ...
    "AWS_Access_Keys.csv": (
        ...
        b"svc-prod-deploy,EXAMPLE_AWS_ACCESS_KEY_REDACTED,wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY\n"
        b"svc-backup,EXAMPLE_AWS_ACCESS_KEY_REDACTED,je7MtGbClwBF/2Zp9Utk/h3yCo8nvbEXAMPLEKEY\n"
    ),
}
